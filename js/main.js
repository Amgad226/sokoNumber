      ...
      var direction= 'right';
        ...
        if(this.inBox==true &&this.outBox==true){
          // alert(1)
                ...
                // console.log(array[X][Y].color, ' move to right  ');
...
console.log(+X+ dir , Y, 88888888888888888888888888888888888888)
// return;
    if(array[+X+ dir][Y]!=null ){
      if(array[+X+ dir][Y].number_inside!=null ){
...
//          var cheack=nextState[X][Y].cheack_move_up(nextState,'nextState',X,Y);
//             if(cheack[0]==false){
//               continue;
//             }
...
//     var cheack=nextState[X][Y].cheack_move_down(nextState,'nextState',X,Y)
//     if(cheack[0]==false){
//       continue;
//     }
//     nextState[X][Y].move_column(nextState,'nextState',X,Y,+1)
...
//     cheack=nextState[X][Y].cheack_move_left(nextState,'nextState',X,Y)
//       if(cheack[0]==false){
//         continue;
//       }
...
//       cheack=nextState[X][Y].cheack_move_right(nextState,'nextState',X,Y)
//       if(cheack[0]==false){
//         continue;
//       }
//       nextState[X][Y]. move_row(nextState,'nextState',X,Y,+1)
